    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        Array.from(moment.range(minDate, maxDate).by('year')).map(function (year) {
          ...
          var className = classnames(classes.yearItem, (_classnames = {}, _defineProperty(_classnames, classes.selectedYear, yearNumber === currentYear), _defineProperty(_classnames, classes.disabled, disableFuture && year.isAfter(moment())), _classnames));
