...
export var Calendar = function (_Component) {
  ...
  function Calendar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return disableFuture && day.isAfter(moment()) || _this.validateMinMaxDate(day) || shouldDisableDate(day);
      ...
      return week.map(function (day) {
        ...
        var dayClass = classnames(classes.day, disabledClass, (_classnames2 = {}, _defineProperty(_classnames2, classes.hidden, !dayInCurrentMonth), _defineProperty(_classnames2, classes.selected, selectedDate.isSame(day, 'day')), _classnames2));
