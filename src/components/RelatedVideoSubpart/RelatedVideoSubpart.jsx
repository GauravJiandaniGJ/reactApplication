		...
		return(
			...
			<div class="row" style={{marginLeft:'1rem', marginTop:'2rem'}}>
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style={{paddingLeft:0}}>
					<div class= "glyphicon glyphicon-play-circle" style={{position:'absolute', display:'block', top:'36%', left:'20%', marginTop:'auto', marginBottom:'auto', textAlign:'center', color:'white', fontSize:'2em',width: '50%',height:'50%'}}></div>
